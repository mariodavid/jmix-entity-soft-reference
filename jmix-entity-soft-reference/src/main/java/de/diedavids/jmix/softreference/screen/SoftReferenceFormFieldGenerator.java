 ...
 *
 *     softReferenceFormFieldGenerator.initSoftReferenceFormField(form, "mySoftReferenceFieldName", instanceContainer);
 *
 *   }
 *
 */
...
public class SoftReferenceFormFieldGenerator {
    ...
    public static final String NAME = "softreference_SoftReferenceFormFieldGenerator";
